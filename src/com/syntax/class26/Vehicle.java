...
public abstract class Vehicle {
    ...
    Vehicle(){
        totalVehicle++;
        System.out.println("I'll be called whenever an object of my Child class will be created using no argument constructor");
    }
    Vehicle(String color){
        totalVehicle++;
        this.color = color;
        System.out.println("I'll be called whenever an object of my Child class will be created using one argument constructor");
    }
    public void drive(){
