...
public class Library {
    String name;
    Book books[];
    Student[] students;//это более красивый способ объявления массива
    Librarian librarian;

    public Library(String name, Book[] book, Student[] students, Librarian librarian) {
        this.name = name;
        this.books = book;
                    ...
                    for (Book studentBooks:student.getBooks()
                        ...
                        if(studentBooks!=null){
                            if(bookVar.getISBN().equals(studentBooks.getISBN())){
                                System.out.println("You've already have this book");
                            }else{
